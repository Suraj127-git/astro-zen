...
export const SITE_CONTENT: SiteContent = {
  ...
  projects: [
    ...
    {
      name: "GenAI Medical Chat Bot",
      summary: "A medical chat bot that uses AI to provide medical advice and answer questions.",
    ...
    },
    {
      ...
      summary: "A blog generator that uses AI to create blog posts based on user input.",
      linkPreview: "https://github.com/surajshetty",
      linkSource: "https://github.com/surajshetty",
      image: cloneIg,
    },
    {
      name: "GenAI Chat Bot",
      summary: "A chat bot that uses AI to generate responses based on user input.",
      linkPreview: "https://github.com/surajshetty",
      linkSource: "https://github.com/surajshetty",
      image: spotifu,
    },
    {
      name: "GenAI Mock Interview ",
      summary: "A mock interview platform that uses AI to simulate real interview scenarios and provide feedback.",
      linkPreview: "https://github.com/surajshetty",
      linkSource: "https://github.com/surajshetty",
      image: spotifu,
    }
